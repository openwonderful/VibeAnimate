/**
 * Medium-resolution screenshot (640x480 canvas).
 * Force canvas resize after load for SwiftShader compatibility.
 */
...
const out = positional[1] || 'out/screenshots/char-med.png'
