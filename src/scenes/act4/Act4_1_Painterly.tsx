/**
 * Act 4.1-Painterly — "Industrialization Timelapse, Painterly Stack"
 *
 * Same 4.1 scene, post-processed with a stack of prebuilt effects tuned
 * for a thicker oil-paint / aquarelle look:
 *   1. Kuwahara (radius 8, 8 sectors) — heavier brushstroke smoothing
 *   2. HueSaturation                  — desaturated, painterly palette
 *   3. BrightnessContrast             — punchier blocks of value
 *   4. Noise                          — paper grain
 *   5. Vignette                       — soft frame
 * Kuwahara is vendored from @tresjs/post-processing (MIT). Everything
 * else is straight from @react-three/postprocessing.
 */
...
// Main export
// ─────────────────────────────────────────────────────────────────────
const Kuwahara = wrapEffect(KuwaharaEffect, { radius: 8, sectorCount: 8 })

export default function Act4_1_Painterly() {
  return (
    <div style={{ width: '100vw', height: '100vh', background: '#000' }}>
      ...
      >
        ...
        <EffectComposer>
          ...
          <BrightnessContrast brightness={0.0} contrast={0.18} />
