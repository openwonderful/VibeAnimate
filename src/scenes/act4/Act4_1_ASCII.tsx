/**
 * Act 4.1-ASCII — "Industrialization Timelapse, ASCII Render"
 *
 * Same 4.1 scene, post-processed with @react-three/postprocessing's
 * `ASCII` effect (wraps pmndrs/postprocessing's ASCIIEffect). The whole
 * scene renders as terminal characters. Single drop-in pass.
 */
...
// Main export
// ─────────────────────────────────────────────────────────────────────
export default function Act4_1_ASCII() {
  return (
