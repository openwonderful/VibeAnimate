/**
 * Act 4.1-Kuwahara — "Industrialization Timelapse, Watercolor"
 *
 * Same 4.1 scene, post-processed with the anisotropic Kuwahara filter
 * (vendored from @tresjs/post-processing, MIT). Kuwahara smooths regions
 * while preserving edges — the canonical algorithm behind painterly /
 * watercolor / aquarelle 3D stylizations.
 *
 * Tweakable: `radius` (brush size), `sectorCount` (smoothness, up to 8).
 */
...
// Main export
// ─────────────────────────────────────────────────────────────────────
const Kuwahara = wrapEffect(KuwaharaEffect, { radius: 6, sectorCount: 8 })

export default function Act4_1_Kuwahara() {
  return (
