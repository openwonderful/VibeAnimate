/**
 * Act 4.1-Linocut — "Industrialization Timelapse, Linocut Print"
 *
 * Same 4.1 scene, post-processed with the Linocut shader (vendored from
 * @tresjs/post-processing, MIT). Renders the scene as black-and-white
 * sinusoidal print lines radiating from `center`. Looks like a hand-cut
 * woodblock or relief print.
 *
 * Tweakable: `scale` (line density), `noiseScale` (grain), `rotation`,
 * `center` (UV space, default [0.5, 0.5]).
 */
...
export default function Act4_1_Linocut() {
  return (
